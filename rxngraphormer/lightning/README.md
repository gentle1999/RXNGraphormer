...
New code should import from `rxngraphormer.lightning`. CLI entry points should
stay thin and delegate training orchestration to `fit_config`/`build_fit_artifacts`.
